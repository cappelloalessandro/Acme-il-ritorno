    ...
    return (
      <div class="app grid col-2">
        ...
        <div>
          ...
          <p class="spiegazione">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis culpa laborum ducimus. Voluptatum nisi corporis deserunt nulla facere reprehenderit iure non id, accusamus quisquam aperiam distinctio totam obcaecati dicta ab?</p>
